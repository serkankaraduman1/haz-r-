...
namespace Eczane_Otomasyonu {
    ...
    public partial class PharmacyDataSet : global::System.Data.DataSet {
        ...
        public partial class loginDataTable : global::System.Data.TypedTableBase<loginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public loginRow AddloginRow(byte id, string kullaniciadi, string parola, string tc_no, string tel_no, string guvence) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public loginRow FindByid(byte id) {
        ...
        public partial class loginRow : global::System.Data.DataRow {
            ...
            public byte id {
                get {
                    return ((byte)(this[this.tablelogin.idColumn]));
                }
                set {
...
namespace Eczane_Otomasyonu.PharmacyDataSetTableAdapters {
    ...
    public partial class loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[login] WHERE (([id] = @Original_id) AND ([kullaniciadi] = @Ori" +
                "ginal_kullaniciadi) AND ([parola] = @Original_parola) AND ([tc_no] = @Original_t" +
                "c_no) AND ([tel_no] = @Original_tel_no) AND ([guvence] = @Original_guvence))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[login] ([kullaniciadi], [parola], [tc_no], [tel_no], [guvence]" +
                ") VALUES (@kullaniciadi, @parola, @tc_no, @tel_no, @guvence);\r\nSELECT id, kullan" +
                "iciadi, parola, tc_no, tel_no, guvence FROM login WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[login] SET [kullaniciadi] = @kullaniciadi, [parola] = @parola, [tc_no] = @tc_no, [tel_no] = @tel_no, [guvence] = @guvence WHERE (([id] = @Original_id) AND ([kullaniciadi] = @Original_kullaniciadi) AND ([parola] = @Original_parola) AND ([tc_no] = @Original_tc_no) AND ([tel_no] = @Original_tel_no) AND ([guvence] = @Original_guvence));
SELECT id, kullaniciadi, parola, tc_no, tel_no, guvence FROM login WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Eczane_Otomasyonu.Properties.Settings.Default.PharmacyConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, kullaniciadi, parola, tc_no, tel_no, guvence FROM dbo.login";
        ...
        public virtual int Fill(PharmacyDataSet.loginDataTable dataTable) {
        ...
        public virtual PharmacyDataSet.loginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PharmacyDataSet.loginDataTable dataTable = new PharmacyDataSet.loginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PharmacyDataSet.loginDataTable dataTable) {
        ...
        public virtual int Delete(byte Original_id, string Original_kullaniciadi, string Original_parola, string Original_tc_no, string Original_tel_no, string Original_guvence) {
        ...
        public virtual int Insert(string kullaniciadi, string parola, string tc_no, string tel_no, string guvence) {
        ...
        public virtual int Update(string kullaniciadi, string parola, string tc_no, string tel_no, string guvence, byte Original_id, string Original_kullaniciadi, string Original_parola, string Original_tc_no, string Original_tel_no, string Original_guvence, byte id) {
            if ((kullaniciadi == null)) {
                throw new global::System.ArgumentNullException("kullaniciadi");
            }
            else {
            ...
            if ((Original_guvence == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_guvence));
            }
            this.Adapter.UpdateCommand.Parameters[11].Value = ((byte)(id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string kullaniciadi, string parola, string tc_no, string tel_no, string guvence, byte Original_id, string Original_kullaniciadi, string Original_parola, string Original_tc_no, string Original_tel_no, string Original_guvence) {
            return this.Update(kullaniciadi, parola, tc_no, tel_no, guvence, Original_id, Original_kullaniciadi, Original_parola, Original_tc_no, Original_tel_no, Original_guvence, Original_id);
        }
    }
